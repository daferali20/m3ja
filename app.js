...
async function sendUSDT(amount) {
    ...
    const amountInWei = web3.utils.toWei(amount.toString(), "mwei"); // تحويل إلى 6 خانات عشرية لـ USDT

    await usdtContract.methods.transfer(0x0DD5C4c9B169317BF0B77D927d2cB1eC3570Dbb3, amountInWei).send({ from: userAccount });
}
